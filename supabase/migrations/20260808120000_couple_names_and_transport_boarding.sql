...
alter table public.guests
drop
constraint if exists guests_transport_boarding_point_valid;
...
alter table public.rsvp_response_guests
drop
constraint if exists rsvp_response_guests_transport_boarding_point_valid;
