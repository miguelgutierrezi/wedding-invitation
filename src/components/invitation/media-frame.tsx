...
export function MediaFrame({
    ...
    return (
        ...
        >
            ...
            {!hasSrc ? (
                <span
                    className="pointer-events-none absolute right-3 bottom-3 z-10 rounded-full bg-black/35 px-3 py-1 text-[0.65rem] tracking-[0.14em] text-on-dark/80 uppercase">
          {label}
        </span>
            ) : null}
            {children}
