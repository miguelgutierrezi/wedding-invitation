...
before update on public.event_guest_media_access
for each row
...
grant all on table public.event_guest_media_access to service_role;
...
grant all on table public.guest_media_uploads to service_role;
...
insert into public.event_guest_media_access (
  event_id,
  token_hash,
  token_preview,
  is_enabled,
