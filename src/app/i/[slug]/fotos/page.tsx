    ...
    <div className="page-shell flex min-h-full flex-1 flex-col bg-cream-figma text-cover-cta-fg">
      <header className="border-b-2 border-cover-cta-fg/10 bg-accent px-6 py-8 sm:px-8">
        <div className="mx-auto w-full max-w-xl">
          <p className="font-[family-name:var(--font-timer)] text-xs tracking-[0.18em] text-cream-figma/80 uppercase">
            {invitation.displayName}
          </p>
          <h1 className="mt-2 font-[family-name:var(--font-timer)] text-3xl text-cream-figma sm:text-4xl">
