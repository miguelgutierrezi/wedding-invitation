...
import {getOutfitInspirationPage, isInspirationAudience,} from "@/lib/invitation/outfit-inspiration";
    ...
    return (
        <main className="flex h-dvh max-h-dvh flex-col overflow-hidden bg-accent text-cover-cta-fg">
            ...
            <div className="flex min-h-0 flex-1 flex-col">
                <div
                    className="flex min-h-0 w-full flex-1 items-start justify-center overflow-y-auto md:landscape:items-center md:landscape:overflow-hidden">
                ...
                <div
                    className="flex shrink-0 justify-center px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:px-8">
