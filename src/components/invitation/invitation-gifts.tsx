...
export function InvitationGifts() {
    ...
    return (
        ...
        >
            <div
                className="mx-auto grid w-full min-w-0 max-w-5xl gap-8 lg:max-w-6xl lg:grid-cols-2 lg:items-center lg:gap-10 xl:gap-12 [&>*]:min-w-0">
                <GiftsIllustration className="order-2 lg:order-1"/>

                <div
                    className="order-1 flex flex-col items-center text-center lg:order-2 lg:items-center lg:justify-center">
