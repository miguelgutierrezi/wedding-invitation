...
export default function HomePage() {
    ...
    return (
        <div className="page-shell relative flex flex-1 flex-col">
            <div
                aria-hidden
                className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(61,90,76,0.14),transparent_55%),radial-gradient(ellipse_at_bottom_right,rgba(31,42,36,0.08),transparent_50%)]"
            />

            <main
                className="relative z-10 mx-auto flex w-full min-w-0 flex-1 flex-col justify-center px-6 py-16 sm:px-10 sm:py-24">
                <p className="text-sm font-medium tracking-[0.22em] text-accent uppercase">
                    {copy.tagline}
                </p>

                <h1 className="mt-6 font-display text-5xl leading-tight font-medium tracking-tight text-foreground sm:text-6xl">
                    {couple.partnerOne}
                ...
                <div
                    className="mt-10 max-w-xl rounded-2xl border border-(--ring) bg-surface p-6 shadow-[0_20px_50px_-32px_rgba(31,42,36,0.45)] backdrop-blur-sm sm:p-8">
