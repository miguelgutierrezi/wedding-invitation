-- Allow unspecified gender for plus-ones whose name/gender is not known yet.

alter table public.guests
drop
constraint if exists guests_gender_valid;
...
comment
on column public.guests.gender is
  'male | female | unspecified; used for singular invitation cover greeting';
